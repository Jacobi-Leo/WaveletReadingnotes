...
\begin{figure}[h]
  \resizebox{540px}{604px}{\includegraphics{Figures/HaarWavelet.png}}
...
\begin{figure}[h]
  \resizebox{278px}{202px}{\includegraphics{Figures/HaarWavelet2.png}}
...
\[ \hat{\psi} (\xi) = \left\{ \begin{array}{ll}
   ...
   \end{array} \right. . \]
\begin{figure}[h]
  \resizebox{424px}{240px}{\includegraphics{Figures/Spectrum_Meyer_scalefunction.png}}
...
\begin{figure}[h]
  \resizebox{526px}{206px}{\includegraphics{Figures/Spectrum_Meyer_wavelet.png}}
...
\begin{thebibliography}{1}
  ...
  \bibitem[8]{walnut2013introduction}David~F Walnut.{\newblock} \tmtextit{An
